...
import MentorScoreCard from './components/Mentor/MentorScoreCard'
import MentorUploadQuiz from './components/Mentor/MentorUploadquiz';
...
function App() {
  const [isMentor, setIsMentor] = useState(false); // State to track if the user is a mentor (false means admin or intern)
    ...
    // Function to add leave request to the state
    const addLeaveRequest = (newLeaveRequest) => {
      ...
      <Routes>
        ...
        <Route element={<Layout />}>
          ...
          <Route path="/mentor/MentorDashboard" element={<MentorDashboard />} />
            <Route path="/mentor/MentorScoreCard" element={<MentorScoreCard />} />
            <Route path="/mentor/interns" element={<MentorInterns />} />
            <Route path="/mentor/reviews" element={<MentorReviews />} />
            <Route path="/mentor/MentorUploadquiz" element={<MentorUploadQuiz/>}/>
